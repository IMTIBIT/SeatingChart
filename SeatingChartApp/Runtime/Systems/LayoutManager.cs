...
namespace SeatingChartApp.Runtime.Systems
{
    ...
    /// information.  Maintains a list of all <see cref="SeatController"/>
    /// instances in the scene, saves their state to disk on change or on
    /// application quit, and restores their positions and occupancy on load.
    /// </summary>
    public class LayoutManager : MonoBehaviour
    {
        ...
        /// This method should be called by the <see cref="AreaManager"/> when
        /// a new seating area is selected.  It saves the current layout,
        /// updates the <see cref="CurrentAreaName"/>, repopulates the
        /// <see cref="Seats"/> list from the provided seats and then loads
        /// the new area's layout from disk.
        /// </summary>
        /// <param name="areaName">Logical name of the new area.</param>
        /// <param name="areaSeats">List of seats belonging to the new area.</param>
        ...
        /// <see cref="Application.persistentDataPath"/>.  Each seat's ID,
        /// anchored position, state and guest (if any) are captured.  If
        /// you wish to debug the output, you can read the generated file
        ...
        public void SaveLayout()
        {
            ...
            foreach (var seat in Seats)
            {
                ...
                var data = new SeatData
                {
                    ...
                    state = seat.State,
                    guest = seat.CurrentGuest != null ? new GuestData(seat.CurrentGuest.FirstName, seat.CurrentGuest.LastName, seat.CurrentGuest.RoomNumber, seat.CurrentGuest.PartySize) : null,
        ...
        public void LoadLayout()
        {
            ...
            try
            {
                ...
                foreach (var data in layout.seats)
                {
                    ...
                    seat.CurrentGuest = data.guest != null ? new GuestData(data.guest.FirstName, data.guest.LastName, data.guest.RoomNumber, data.guest.PartySize) : null;
