...
namespace SeatingChartApp.Runtime.Systems
{
    ...
    /// <see cref="LayoutManager"/> is updated with the new seat list and the
    /// layout is loaded from an area‑specific file.  The area dropdown is
    /// automatically populated from the list of area names.
    /// </summary>
    public class AreaManager : MonoBehaviour
    {
        ...
        /// them to the <see cref="LayoutManager"/> for management.
        /// </summary>
