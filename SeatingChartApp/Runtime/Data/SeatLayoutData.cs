...
namespace SeatingChartApp.Runtime.Data
{
    ...
    /// the scene.  This is used by the <see cref="LayoutManager"/> to persist
    ...
    /// <see cref="SeatState"/>, and an optional <see cref="GuestData"/> if the
    /// seat is occupied.  Vector2 is used for the anchored position because
    /// <see cref="Vector2"/> is serializable by <see cref="JsonUtility"/>.
    /// </summary>
    [Serializable]
